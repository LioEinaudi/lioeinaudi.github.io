...
我是**赵锦彬**,网名 **Lio Einaudi**。我做 LLM 推理性能优化:GPU kernel、MoE 调优、确定性(batch-invariant)推理。开源工作主要在 [vLLM](https://github.com/vllm-project/vllm/pulls?q=author%3ALioEinaudi)。
